...
</span>}</code></pre></div></div></div></div></div><div id="сайты-post" class="action post"><div class="action-name"><span class="action-resource">Сайты</span><span class="action-dif">/</span><span class="action-title">Добавить новый сайт</span></div><h4 class="action-heading"><a href="#сайты-post" class="method post">POST</a><code class="uri">http://analitics.catkitcms.ru/api/sites</code></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">project_id</td><td><span class="attribute-type">number</span><p>ID проекта, к которому относится сайт.</p></td></tr><tr><td class="attribute-status"><span class="required"></span></td><td width="">domain</td><td><span class="attribute-type">string</span><p>Доменное имя сайта.</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
...
</span>}</code></pre></div></div></div></div></div><div id="кампании-post" class="action post"><div class="action-name"><span class="action-resource">Кампании</span><span class="action-dif">/</span><span class="action-title">Добавить новую кампанию</span></div><h4 class="action-heading"><a href="#кампании-post" class="method post">POST</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns</code></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">site_id</td><td><span class="attribute-type">number</span><p>ID сайта, к которому относится кампания</p></td></tr><tr><td class="attribute-status"><span class="required"></span></td><td width="">profile_id</td><td><span class="attribute-type">number</span><p>ID профиля, которому принадлежит кампания</p></td></tr><tr><td class="attribute-status"><span class="required"></span></td><td width="">key</td><td><span class="attribute-type">number</span><p>Идентификатор кампании в соответствующей профилю системе</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Название кампании</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">site_id</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">options</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">max</td><td><span class="attribute-type">number</span><p>Максимальная ставка</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">position</td><td><span class="attribute-type">string</span><p>Позиция, строка по формуле Pnm, где n - , m -</p><p><b>P11</b></p><p><b>P12</b></p><p><b>P13</b></p><p><b>P14</b></p><p><b>P21</b></p><p><b>P22</b></p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">increment</td><td><span class="attribute-type">number</span><p>Процент завышения ставки</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">active</td><td><span class="attribute-type">boolean</span><p>Статус (включено/выключено)</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">day_num</td><td><span class="attribute-type">number</span><p>Порядковый номер дня недели от 0 (понедельник) до 6, для которого должны применяться настройки</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">hour_num</td><td><span class="attribute-type">number</span><p>Порядковый номер часа от 0 до 23, для которого должны применяться настройки</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">hit</td><td><span class="attribute-type">number</span><p>Показатель попадания ставки в процентах за указанный час. Отражает количество ставок, процент завышения которых не превышал максимальное значение, к общему количеству ставок по кампании. В расчет принимаются только ставки, сделанные по этой группе настроек, - если настройки биддера для кампании были переопределены настройками группы объявлений и/или ключевой фразы, они не учитываются. Значение для группы настроек обновляется при каждом ее использовании биддером.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">overrides</td><td><span class="attribute-type">object</span><p>список ID дочерних элементов, которые переопределяют настройки кампании</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">ag_group_ids</td><td><span class="attribute-type"></span><p>ID групп объявлений кампании, для которых указаны другие настройки биддера</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">keyword_ids</td><td><span class="attribute-type"></span><p>ID ключевых фраз кампании, для которых указаны другие настройки биддера</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">hit</td><td><span class="attribute-type">number</span><p>Показатель попадания ставки в процентах, рассчитанный при последнем срабатывании биддера для этой кампании.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    ...
    "<span class="hljs-attribute">overrides</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">ag_group_ids</span>": <span class="hljs-value">[]</span>,
      "<span class="hljs-attribute">keyword_ids</span>": <span class="hljs-value">[]
    </span>}</span>,
    "<span class="hljs-attribute">hit</span>": <span class="hljs-value"><span class="hljs-number">1</span>
  </span>}
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
    ...
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        ...
        "<span class="hljs-attribute">overrides</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
          "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
            "<span class="hljs-attribute">ag_group_ids</span>": <span class="hljs-value">{
              "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"ID групп объявлений кампании, для которых указаны другие настройки биддера"</span>
            </span>}</span>,
            "<span class="hljs-attribute">keyword_ids</span>": <span class="hljs-value">{
              "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"ID ключевых фраз кампании, для которых указаны другие настройки биддера"</span>
            </span>}
          </span>}</span>,
...
</span>}</code></pre></div></div></div></div></div><div id="группы-объявлений-get-3" class="action get"><div class="action-name"><span class="action-resource">Группы объявлений</span><span class="action-dif">/</span><span class="action-title">Текущие настройки биддера</span></div><h4 class="action-heading"><a href="#группы-объявлений-get-3" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/ad_groups/{id}/bids</code></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID группы объявлений</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">max</td><td><span class="attribute-type">number</span><p>Максимальная ставка</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">position</td><td><span class="attribute-type">string</span><p>Позиция, строка по формуле Pnm, где n - , m -</p><p><b>P11</b></p><p><b>P12</b></p><p><b>P13</b></p><p><b>P14</b></p><p><b>P21</b></p><p><b>P22</b></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">increment</td><td><span class="attribute-type">number</span><p>Процент завышения ставки</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">active</td><td><span class="attribute-type">boolean</span><p>Статус (включено/выключено)</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">max</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">position</span>": <span class="hljs-value"><span class="hljs-string">"P11"</span></span>,
  "<span class="hljs-attribute">increment</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID группы объявлений</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">orders</span>": <span class="hljs-value"><span class="hljs-number">1</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="ключевые-фразы-get-2" class="action get"><div class="action-name"><span class="action-resource">Ключевые фразы</span><span class="action-dif">/</span><span class="action-title">Текущие настройки биддера</span></div><h4 class="action-heading"><a href="#ключевые-фразы-get-2" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/keywords/{id}/bids</code></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID ключевой фразы</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">max</td><td><span class="attribute-type">number</span><p>Максимальная ставка</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">position</td><td><span class="attribute-type">string</span><p>Позиция, строка по формуле Pnm, где n - , m -</p><p><b>P11</b></p><p><b>P12</b></p><p><b>P13</b></p><p><b>P14</b></p><p><b>P21</b></p><p><b>P22</b></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">increment</td><td><span class="attribute-type">number</span><p>Процент завышения ставки</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">active</td><td><span class="attribute-type">boolean</span><p>Статус (включено/выключено)</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">max</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">position</span>": <span class="hljs-value"><span class="hljs-string">"P11"</span></span>,
  "<span class="hljs-attribute">increment</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">active</span>": <span class="hljs-value"><span class="hljs-literal">true</span>
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID ключевой фразы</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
...
</span>}</code></pre></div></div></div></div></div><div id="биддер-put" class="action put"><div class="action-name"><span class="action-resource">Биддер</span><span class="action-dif">/</span><span class="action-title">Обновить настройки запуска биддера</span></div><h4 class="action-heading"><a href="#биддер-put" class="method put">PUT</a><code class="uri">http://analitics.catkitcms.ru/api/bidder/period</code></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">period</td><td><span class="attribute-type">number</span><p>Интервал запуска биддера в минутах</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span>
</span>}</code></pre></div></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button">Headers</a></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div id="звонки" class="resource"><div id="звонки-get" class="action get"><div class="action-name"><span class="action-resource">Звонки</span><span class="action-dif">/</span><span class="action-title">Добавление информации о новом звонке</span></div><h4 class="action-heading"><a href="#звонки-get" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/calls/push</code></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">unique</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">site</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">callerphone</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">duration</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">reclink</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">timestamp</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_source</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_medium</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_campaign</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_content</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_term</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span>
</span>}</code></pre></div></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button">Headers</a></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 13 Dec 2017</p><script>/*
