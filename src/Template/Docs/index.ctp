...
Каждый ресурс принимает дополнительные параметры <code>page=page,count</code>, <code>order=field</code>, <code>reverse=1</code> и возвращает заголовок <code>RecordsCount</code> с общим количеством найденных результатов.</p>
