<!DOCTYPE html><html><head><meta charset="utf-8"><title>Аналитика</title><link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css"><style>@import url('https://fonts.googleapis.com/css?family=Roboto:400,700|Inconsolata|Raleway:200');.hljs-comment,.hljs-title{color:#8e908c}.hljs-variable,.hljs-attribute,.hljs-tag,.hljs-regexp,.ruby .hljs-constant,.xml .hljs-tag .hljs-title,.xml .hljs-pi,.xml .hljs-doctype,.html .hljs-doctype,.css .hljs-id,.css .hljs-class,.css .hljs-pseudo{color:#c82829}.hljs-number,.hljs-preprocessor,.hljs-pragma,.hljs-built_in,.hljs-literal,.hljs-params,.hljs-constant{color:#f5871f}.ruby .hljs-class .hljs-title,.css .hljs-rules .hljs-attribute{color:#eab700}.hljs-string,.hljs-value,.hljs-inheritance,.hljs-header,.ruby .hljs-symbol,.xml .hljs-cdata{color:#718c00}.css .hljs-hexcolor{color:#3e999f}.hljs-function,.python .hljs-decorator,.python .hljs-title,.ruby .hljs-function .hljs-title,.ruby .hljs-title .hljs-keyword,.perl .hljs-sub,.javascript .hljs-title,.coffeescript .hljs-title{color:#4271ae}.hljs-keyword,.javascript .hljs-function{color:#8959a8}.hljs{display:block;background:white;color:#4d4d4c;padding:.5em}.coffeescript .javascript,.javascript .xml,.tex .hljs-formula,.xml .javascript,.xml .vbscript,.xml .css,.xml .hljs-cdata{opacity:.5}.right .hljs-comment{color:#969896}.right .css .hljs-class,.right .css .hljs-id,.right .css .hljs-pseudo,.right .hljs-attribute,.right .hljs-regexp,.right .hljs-tag,.right .hljs-variable,.right .html .hljs-doctype,.right .ruby .hljs-constant,.right .xml .hljs-doctype,.right .xml .hljs-pi,.right .xml .hljs-tag .hljs-title{color:#c66}.right .hljs-built_in,.right .hljs-constant,.right .hljs-literal,.right .hljs-number,.right .hljs-params,.right .hljs-pragma,.right .hljs-preprocessor{color:#de935f}.right .css .hljs-rule .hljs-attribute,.right .ruby .hljs-class .hljs-title{color:#f0c674}.right .hljs-header,.right .hljs-inheritance,.right .hljs-name,.right .hljs-string,.right .hljs-value,.right .ruby .hljs-symbol,.right .xml .hljs-cdata{color:#b5bd68}.right .css .hljs-hexcolor,.right .hljs-title{color:#8abeb7}.right .coffeescript .hljs-title,.right .hljs-function,.right .javascript .hljs-title,.right .perl .hljs-sub,.right .python .hljs-decorator,.right .python .hljs-title,.right .ruby .hljs-function .hljs-title,.right .ruby .hljs-title .hljs-keyword{color:#81a2be}.right .hljs-keyword,.right .javascript .hljs-function{color:#b294bb}.right .hljs{display:block;overflow-x:auto;background:#1d1f21;color:#c5c8c6;padding:.5em;-webkit-text-size-adjust:none}.right .coffeescript .javascript,.right .javascript .xml,.right .tex .hljs-formula,.right .xml .css,.right .xml .hljs-cdata,.right .xml .javascript,.right .xml .vbscript{opacity:.5}body{color:black;background:rgba(234,234,231,0.66);font:400 14px / 1.42 'Roboto',Helvetica,sans-serif;margin:0}header{border-bottom:1px solid #f2f2f2;margin-bottom:12px}h1,h2,h3,h4,h5{color:black;margin:12px 0}h1 .permalink,h2 .permalink,h3 .permalink,h4 .permalink,h5 .permalink{margin-left:0;opacity:0;transition:opacity .25s ease}h1:hover .permalink,h2:hover .permalink,h3:hover .permalink,h4:hover .permalink,h5:hover .permalink{opacity:1}.triple h1 .permalink,.triple h2 .permalink,.triple h3 .permalink,.triple h4 .permalink,.triple h5 .permalink{opacity:.15}.triple h1:hover .permalink,.triple h2:hover .permalink,.triple h3:hover .permalink,.triple h4:hover .permalink,.triple h5:hover .permalink{opacity:.15}h1{font:200 36px 'Raleway',Helvetica,sans-serif;font-size:36px}h2{font:200 36px 'Raleway',Helvetica,sans-serif;font-size:30px}h3{font-size:100%;text-transform:uppercase}h5{font-size:100%;font-weight:normal}p{margin:0 0 10px}p.choices{line-height:1.6}a{color:#428bca;text-decoration:none}li p{margin:0}hr.split{border:0;height:1px;width:100%;padding-left:6px;margin:12px auto;background-image:linear-gradient(to right, rgba(0,0,0,0) 20%, rgba(0,0,0,0.2) 51.4%, rgba(255,255,255,0.2) 51.4%, rgba(255,255,255,0) 80%)}dl dt{float:left;width:130px;clear:left;text-align:right;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:700}dl dd{margin-left:150px}blockquote{color:rgba(0,0,0,0.5);font-size:15.5px;padding:10px 20px;margin:12px 0;border-left:5px solid #e8e8e8}blockquote p:last-child{margin-bottom:0}pre{background-color:#f5f5f5;padding:12px;border:1px solid #cfcfcf;border-radius:6px;overflow:auto}pre code{color:black;background-color:transparent;padding:0;border:none}code{color:#444;background-color:#f5f5f5;font:'Inconsolata',monospace;padding:1px 4px;border:1px solid #cfcfcf;border-radius:3px}ol,ul{padding-left:2em}table{border-collapse:collapse;border-spacing:0;margin-bottom:12px}table tr{border-top:1px solid #ddd}table tr:first-child{border-top:none}table td{border:none;padding:12px 12px 0;vertical-align:top}table td.attribute-status{text-align:right;width:50px}table td.attribute-status span{display:inline-block;width:6px;height:6px;background:none;border:2px solid #ccc;border-radius:5px;line-height:8px}table td.attribute-status span.required{background:#ccc}table .attribute-type{display:inline-block;padding:0 14px;background:#d0d0d0;border-radius:4px;color:#fff;font-size:13px;margin:0 0 3px}.text-muted{opacity:.5}.note,.warning{padding:.3em 1em;margin:1em 0;border-radius:2px;font-size:90%}.note h1,.warning h1,.note h2,.warning h2,.note h3,.warning h3,.note h4,.warning h4,.note h5,.warning h5,.note h6,.warning h6{font-family:200 36px 'Raleway',Helvetica,sans-serif;font-size:135%;font-weight:500}.note p,.warning p{margin:.5em 0}.note{color:black;background-color:#f0f6fb;border-left:4px solid #428bca}.note h1,.note h2,.note h3,.note h4,.note h5,.note h6{color:#428bca}.warning{color:black;background-color:#fbf1f0;border-left:4px solid #c9302c}.warning h1,.warning h2,.warning h3,.warning h4,.warning h5,.warning h6{color:#c9302c}header{margin-top:24px}nav{position:fixed;top:0;bottom:0;overflow-y:auto}nav .resource-group{padding:0}nav .resource-group .heading{position:relative}nav .resource-group .heading .chevron{position:absolute;top:12px;right:12px;opacity:.5}nav .resource-group .heading a{display:block;color:black;opacity:.7;border-left:2px solid transparent;margin:0}nav .resource-group .heading a:hover{text-decoration:none;background-color:bad-color;border-left:2px solid black}nav ul{list-style-type:none;padding-left:0}nav ul a{display:block;font-size:13px;color:rgba(0,0,0,0.7);padding:8px 12px;border-top:1px solid #d9d9d9;border-left:2px solid transparent;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}nav ul a:hover{text-decoration:none;background-color:bad-color;border-left:2px solid black}nav ul>li{margin:0}nav ul>li:first-child{margin-top:-12px}nav ul>li:last-child{margin-bottom:-12px}nav ul ul a{padding-left:24px}nav ul ul li{margin:0}nav ul ul li:first-child{margin-top:0}nav ul ul li:last-child{margin-bottom:0}nav>div>div>ul>li:first-child>a{border-top:none}.preload *{transition:none !important}.pull-left{float:left}.pull-right{float:right}.badge{display:inline-block;float:right;width:10px;height:10px;border-radius:5px;margin:4px 0 0 0}.badge.get{color:#70bbe1;background-color:#d9edf7}.badge.head{color:#70bbe1;background-color:#d9edf7}.badge.options{color:#70bbe1;background-color:#d9edf7}.badge.put{color:#f0db70;background-color:#fcf8e3}.badge.patch{color:#f0db70;background-color:#fcf8e3}.badge.post{color:#93cd7c;background-color:#dff0d8}.badge.delete{color:#ce8383;background-color:#f2dede}.collapse-button{float:right}.collapse-button .close{display:none;color:#428bca;cursor:pointer}.collapse-button .open{color:#428bca;cursor:pointer}.collapse-button.show .close{display:inline}.collapse-button.show .open{display:none}.collapse-content{max-height:0;overflow:hidden;transition:max-height .3s ease-in-out}nav{width:220px}.container{max-width:940px;margin-left:auto;margin-right:auto}.container .row .content{margin-left:244px;width:696px}.container .row:after{content:'';display:block;clear:both}.container-fluid nav{width:22%}.container-fluid .row .content{margin-left:24%;padding-right:20px}.container-fluid.triple nav{width:16.5%;padding-right:1px}.container-fluid.triple .row .content{position:relative;margin-left:16.5%;padding-left:24px}.middle:after,.middle:before{content:'';display:table}.middle:after{clear:both}.middle{box-sizing:border-box;width:51.5%;padding-right:12px}.right{box-sizing:border-box;float:right;width:48.5%;padding-left:12px}.right a{color:#428bca}.right div,.right h1,.right h2,.right h3,.right h4,.right h5,.right p{color:white}.right pre{background-color:#1d1f21;border:1px solid #1d1f21}.right pre code{color:#c5c8c6}.right .description{margin-top:12px}.triple .resource-heading{font-size:125%}.definition{margin-top:12px;margin-bottom:12px}.definition .method{font-weight:bold}.definition .method.get{color:#2e8ab8}.definition .method.head{color:#2e8ab8}.definition .method.options{color:#2e8ab8}.definition .method.post{color:#56b82e}.definition .method.put{color:#b8a22e}.definition .method.patch{color:#b8a22e}.definition .method.delete{color:#b82e2e}.definition .uri{word-break:break-all;word-wrap:break-word}.definition .hostname{opacity:.5}.example-names{background-color:#eee;padding:12px;border-radius:6px}.example-names .tab-button{cursor:pointer;color:black;border:1px solid #ddd;padding:6px;margin-left:12px}.example-names .tab-button.active{background-color:#d5d5d5}.right .example-names{background-color:#444}.right .example-names .tab-button{color:white;border:1px solid #666;border-radius:6px}.right .example-names .tab-button.active{background-color:#5e5e5e}#nav-background{position:fixed;left:0;top:0;bottom:0;width:16.5%;padding-right:14.4px;background-color:#fbfbfb;border-right:1px solid #f0f0f0;z-index:-1}#right-panel-background{position:absolute;right:-12px;top:-12px;bottom:-12px;width:48.6%;background-color:#333;z-index:-1}@media (max-width:1200px){nav{width:198px}.container{max-width:840px}.container .row .content{margin-left:224px;width:606px}}@media (max-width:992px){nav{width:169.4px}.container{max-width:720px}.container .row .content{margin-left:194px;width:526px}}@media (max-width:768px){nav{display:none}.container{width:95%;max-width:none}.container .row .content,.container-fluid .row .content,.container-fluid.triple .row .content{margin-left:auto;margin-right:auto;width:95%}#nav-background{display:none}#right-panel-background{width:48.6%}}.back-to-top{position:fixed;z-index:1;bottom:0;right:24px;padding:4px 8px;color:rgba(0,0,0,0.5);background-color:#f2f2f2;text-decoration:none !important;border-top:1px solid #d9d9d9;border-left:1px solid #d9d9d9;border-right:1px solid #d9d9d9;border-top-left-radius:3px;border-top-right-radius:3px}.resource-group{padding:12px;margin-bottom:12px;background-color:white;border:1px solid #d9d9d9}.resource-group .heading a,.resource-group h2.group-heading{padding:12px;margin:-12px -12px 12px -12px;background-color:#f2f2f2;border-bottom:1px solid #d9d9d9;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.triple .content .resource-group{padding:0;border:none}.triple .content .resource-group .heading a,.triple .content .resource-group h2.group-heading{margin:0 0 12px;border:1px solid #d9d9d9}nav .resource-group .heading a{padding:12px;margin-bottom:0}nav .resource-group .collapse-content{padding:0}.action{margin-bottom:40px;padding:12px 12px 0;overflow:hidden;border:1px solid #d9d9d8;border-radius:6px;padding-bottom:20px;background:#fff}.action .action-name{font-size:18px;position:relative;white-space:nowrap;line-height:1;text-align:center;margin:10px 0;height:30px;font-weight:400;color:#000}.action h4.action-heading{padding:0;margin:5px 5px 15px;border-width:1px;border-style:solid;border-radius:4px;height:40px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.action h4.action-heading .name{float:right;font-weight:normal}.action h4.action-heading .method{padding:0;margin-right:12px;border-radius:0;line-height:40px;height:40px;display:block;width:64px;text-align:center;font-size:16px;color:#fff !important;float:left}.action h4.action-heading code{height:40px;display:block;line-height:40px;font-size:15px;background-color:transparent;padding:0;border:none}.action dl.inner{padding-bottom:2px}.action .title{border-bottom:1px solid white;margin:0 -12px -1px;padding:12px;color:#666;font-size:16px}.action .title:after{content:'';display:block;width:100%;height:1px;background:#cdcdcd;margin:-11px 0 0 0}.action .title strong{background:#fff;padding:0 10px 0 0;font-weight:300}.action .title .collapse-button{padding:0 0 0 8px;background:#fff}.action .title .collapse-button *{color:#666}.action.get h4.action-heading,.action.get h4.action-heading code{color:#337ab7}.action.get h4.action-heading .method{background-color:#337ab7}.action.head h4.action-heading,.action.head h4.action-heading code{color:#337ab7}.action.head h4.action-heading .method{background-color:#337ab7}.action.options h4.action-heading,.action.options h4.action-heading code{color:#337ab7}.action.options h4.action-heading .method{background-color:#337ab7}.action.post h4.action-heading,.action.post h4.action-heading code{color:#5cb85c}.action.post h4.action-heading .method{background-color:#5cb85c}.action.put h4.action-heading,.action.put h4.action-heading code{color:#ed9c28}.action.put h4.action-heading .method{background-color:#ed9c28}.action.patch h4.action-heading,.action.patch h4.action-heading code{color:#ed9c28}.action.patch h4.action-heading .method{background-color:#ed9c28}.action.delete h4.action-heading,.action.delete h4.action-heading code{color:#d9534f}.action.delete h4.action-heading .method{background-color:#d9534f}.tabs.r-tabs{border-top:solid 1px #ddd !important;border-bottom:solid 1px #ddd !important;background-color:rgba(0,0,0,0.03);padding:.5em 1em !important}.r-tabs .tabs-menu{box-shadow:none !important;border:none;background:none;border-bottom:1px solid #D4D4D5;bottom:0;margin-bottom:0;top:0}.r-tabs .tabs-menu a{background:0 0;border-bottom:none;border-left:1px solid transparent;border-right:1px solid transparent;border-top:2px solid transparent;color:rgba(0,0,0,0.87);margin:0;width:120px;display:inline-block;text-align:center;line-height:40px;height:40px;text-transform:uppercase;cursor:pointer}.r-tabs .tabs-menu a.active{background:#FFF;color:rgba(0,0,0,0.95);border-top-width:1px;border-color:#D4D4D5;font-weight:700;margin-bottom:-1px;box-shadow:none;border-radius:.28571429rem .28571429rem 0 0 !important;border-bottom:1px solid #fff}.r-tabs .tab{border-bottom:solid 1px #ddd !important;background:#fff;padding:.5em 1em !important;display:none;min-height:100px;border-left:1px solid #D4D4D5;border-right:1px solid #D4D4D5}r-tabs .tab.active{display:block}</style></head><body class="preload"><a href="#top" class="text-muted back-to-top"><i class="fa fa-toggle-up"></i>&nbsp;Back to top</a><div class="container-fluid"><div class="row"><nav><div class="resource-group"><div class="heading"><div class="chevron"><i class="open fa fa-angle-down"></i></div><a href="#top">Overview</a></div><div class="collapse-content"><ul><li><a href="#header-аутентификация">Аутентификация</a></li><li><a href="#header-rest">REST</a></li><li><a href="#header-возвращаемый-результат">Возвращаемый результат</a></li><li><a href="#header-объект-ответа">Объект ответа</a></li></ul></div></div><div class="resource-group"><div class="heading"><div class="chevron"><i class="open fa fa-angle-down"></i></div><a href="#">Resource Group</a></div><div class="collapse-content"><ul><li><a href="#проекты"><b>Проекты</b></a><ul><li><a href="#проекты-get"><span class="badge get"></span>Список проектов</a></li><li><a href="#проекты-get-1"><span class="badge get"></span>Детали проекта</a></li><li><a href="#проекты-get-2"><span class="badge get"></span>Список сайтов</a></li><li><a href="#проекты-get-3"><span class="badge get"></span>Список кампаний</a></li><li><a href="#проекты-get-4"><span class="badge get"></span>Общая статистика проекта</a></li><li><a href="#проекты-get-5"><span class="badge get"></span>Подробная статистика проекта</a></li><li><a href="#проекты-get-6"><span class="badge get"></span>Список заявок</a></li></ul></li><li><a href="#сайты"><b>Сайты</b></a><ul><li><a href="#сайты-get"><span class="badge get"></span>Список сайтов</a></li><li><a href="#сайты-post"><span class="badge post"></span>Добавить новый сайт</a></li><li><a href="#сайты-get-1"><span class="badge get"></span>Детали сайта</a></li><li><a href="#сайты-delete"><span class="badge delete"></span>Удалить сайт</a></li><li><a href="#сайты-get-2"><span class="badge get"></span>Список кампаний</a></li><li><a href="#сайты-post-1"><span class="badge post"></span>Добавление заказа</a></li><li><a href="#сайты-post-2"><span class="badge post"></span>Добавление произвольного расхода</a></li><li><a href="#сайты-get-3"><span class="badge get"></span>Общая статистика сайта</a></li><li><a href="#сайты-get-4"><span class="badge get"></span>Подробная статистика сайта</a></li><li><a href="#сайты-put"><span class="badge put"></span>Обновление статистики сайта</a></li></ul></li><li><a href="#кампании"><b>Кампании</b></a><ul><li><a href="#кампании-get"><span class="badge get"></span>Список кампаний</a></li><li><a href="#кампании-post"><span class="badge post"></span>Добавить новую кампанию</a></li><li><a href="#кампании-get-1"><span class="badge get"></span>Детали кампании</a></li><li><a href="#кампании-delete"><span class="badge delete"></span>Удалить кампанию</a></li><li><a href="#кампании-get-2"><span class="badge get"></span>Общая статистика кампании</a></li><li><a href="#кампании-get-3"><span class="badge get"></span>Подробная статистика кампании</a></li><li><a href="#кампании-get-4"><span class="badge get"></span>Текущие настройки биддера</a></li><li><a href="#кампании-put"><span class="badge put"></span>Обновить настройки биддера</a></li><li><a href="#кампании-get-5"><span class="badge get"></span>Список ключевых фраз</a></li><li><a href="#кампании-get-6"><span class="badge get"></span>Список объявлений</a></li><li><a href="#кампании-get-7"><span class="badge get"></span>Список групп объявлений</a></li><li><a href="#кампании-get-8"><span class="badge get"></span>Обновить содержимое кампании</a></li></ul></li><li><a href="#объявления-get"><span class="badge get"></span>Детали объявления</a></li><li><a href="#группы-объявлений"><b>Группы объявлений</b></a><ul><li><a href="#группы-объявлений-get"><span class="badge get"></span>Детали группы</a></li><li><a href="#группы-объявлений-get-1"><span class="badge get"></span>Список ключевых фраз</a></li><li><a href="#группы-объявлений-get-2"><span class="badge get"></span>Текущие настройки биддера</a></li><li><a href="#группы-объявлений-put"><span class="badge put"></span>Обновить настройки биддера</a></li></ul></li><li><a href="#ключевые-фразы"><b>Ключевые фразы</b></a><ul><li><a href="#ключевые-фразы-get"><span class="badge get"></span>Детали ключевой фразы</a></li><li><a href="#ключевые-фразы-get-1"><span class="badge get"></span>Текущие настройки биддера</a></li><li><a href="#ключевые-фразы-put"><span class="badge put"></span>Обновить настройки биддера</a></li></ul></li></ul></div></div><p style="text-align: center; word-wrap: break-word;"><a href="http://analitics.catkitcms.ru/api">http://analitics.catkitcms.ru/api</a></p></nav><div class="content"><header><h1 id="top">Аналитика</h1></header><h3 id="header-аутентификация">Аутентификация <a class="permalink" href="#header-аутентификация" aria-hidden="true">¶</a></h3>
...
<div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID сайта</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td>data</td><td><span class="attribute-type">array</span><p></p></td><td></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>time</td><td><span class="attribute-type">string</span><p>Время, за которое предоставляется стастистика (в формате UTC).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>statistics</td><td><span class="attribute-type">object</span><p>Объект со статистикой за указанное время</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
...
</span>}</code></pre></div></div></div></div></div><div id="кампании-post" class="action post"><div class="action-name">Добавить новую кампанию</div><h4 class="action-heading"><a href="#кампании-post" class="method post">POST</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns</code></h4><div class="title"><strong>Request</strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td>site_id</td><td><span class="attribute-type">number</span><p>ID сайта, к которому относится кампания</p></td><td></td></tr><tr><td class="attribute-status"><span class="required"></span></td><td>type</td><td><span class="attribute-type">string</span><p>Тип кампании (yandex, adwords)</p></td><td></td></tr><tr><td class="attribute-status"><span class="required"></span></td><td>key</td><td><span class="attribute-type">number</span><p>Идентификатор кампании в соответствующей типу системе</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>caption</td><td><span class="attribute-type">string</span><p>Название кампании</p></td><td></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">site_id</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    ...
    "<span class="hljs-attribute">type</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Тип кампании (yandex, adwords)"</span>
    </span>}</span>,
    "<span class="hljs-attribute">key</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Идентификатор кампании в соответствующей типу системе"</span>
    </span>}</span>,
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="кампании-get-1" class="action get"><div class="action-name">Детали кампании</div><h4 class="action-heading"><a href="#кампании-get-1" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns/{id}</code></h4><div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>caption</td><td><span class="attribute-type">string</span><p>Заголовок кампании</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>site_id</td><td><span class="attribute-type">number</span><p>ID сайта, которому принадлежит кампания</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>type</td><td><span class="attribute-type">number</span><p>Тип кампании</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>num</td><td><span class="attribute-type">number</span><p>Номер кампании в системе статистики</p></td><td></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  ...
  "<span class="hljs-attribute">num</span>": <span class="hljs-value"><span class="hljs-number">1</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
...
<div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td>data</td><td><span class="attribute-type">array</span><p></p></td><td></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>time</td><td><span class="attribute-type">string</span><p>Время, за которое предоставляется стастистика (в формате UTC).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>statistics</td><td><span class="attribute-type">object</span><p>Объект со статистикой за указанное время</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span>
</span>}</code></pre></div></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"></div></div></div></div></div><div id="кампании-get-5" class="action get"><div class="action-name">Список ключевых фраз</div><h4 class="action-heading"><a href="#кампании-get-5" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns/{id}/keywords</code></h4><p>Возвращает список ключевых фраз кампании.</p>
<div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td>data</td><td><span class="attribute-type">array</span><p></p></td><td></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID ключевой фразы</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">1</span>
    </span>}
...
</span>}</code></pre></div></div></div></div></div><div id="кампании-get-6" class="action get"><div class="action-name">Список объявлений</div><h4 class="action-heading"><a href="#кампании-get-6" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns/{id}/ads</code></h4><div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"></div></div></div></div></div><div id="кампании-get-7" class="action get"><div class="action-name">Список групп объявлений</div><h4 class="action-heading"><a href="#кампании-get-7" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns/{id}/ad-groups</code></h4><div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"></div></div></div></div></div><div id="кампании-get-8" class="action get"><div class="action-name">Обновить содержимое кампании</div><h4 class="action-heading"><a href="#кампании-get-8" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/campaigns/{id}/sync</code></h4><p>Запускает подгрузку ключевых фраз, объявлений и статусов с серверов поисковых систем немедленно.</p>
<div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"></div></div></div></div></div></div><div id="объявления" class="resource"><h3 class="resource-heading">Объявления <a href="#объявления" class="permalink">&nbsp;&para;</a></h3><div id="объявления-get" class="action get"><div class="action-name">Детали объявления</div><h4 class="action-heading"><a href="#объявления-get" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/ads/{id}</code></h4><div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID объявления</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"></div></div></div></div></div></div><div id="группы-объявлений" class="resource"><h3 class="resource-heading">Группы объявлений <a href="#группы-объявлений" class="permalink">&nbsp;&para;</a></h3><div id="группы-объявлений-get" class="action get"><div class="action-name">Детали группы</div><h4 class="action-heading"><a href="#группы-объявлений-get" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/ad-groups/</code></h4></div><div id="группы-объявлений-get-1" class="action get"><div class="action-name">Список ключевых фраз</div><h4 class="action-heading"><a href="#группы-объявлений-get-1" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/ad-groups/keywords</code></h4></div><div id="группы-объявлений-get-2" class="action get"><div class="action-name">Текущие настройки биддера</div><h4 class="action-heading"><a href="#группы-объявлений-get-2" class="method get">GET</a><code class="uri">http://analitics.catkitcms.ru/api/ad-groups/{id}/bids</code></h4><div class="title"><strong>Parameters</strong><div class="collapse-button show"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID группы объявлений</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong><div class="collapse-button"><i class="fa fa-arrow-down close"></i><i class="fa fa-arrow-left open"></i></div></div><div class="collapse-content"><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td>max</td><td><span class="attribute-type">number</span><p>Максимальная ставка</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>position</td><td><span class="attribute-type">string</span><p>Позиция, строка по формуле Pnm, где n - , m -</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>increment</td><td><span class="attribute-type">number</span><p>Процент завышения ставки</p></td><td></td></tr><tr><td class="attribute-status"><span></span></td><td>active</td><td><span class="attribute-type">boolean</span><p>Статус (включено/выключено)</p></td><td></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">max</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">position</span>": <span class="hljs-value"><span class="hljs-string">"P11"</span></span>,
  "<span class="hljs-attribute">increment</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">active</span>": <span class="hljs-value"><span class="hljs-literal">true</span>
