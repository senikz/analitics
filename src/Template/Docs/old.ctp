...
<ul>
<li>
<p>Добавлен раздел <code>Источники трафика</code>;</p>
</li>
<li>
<p>В раздел сайтов добавлен метод получения всех источников трафика для отдельного сайта;</p>
</li>
<li>
<p>Из раздела сайтов удален метод получения всех кампаний сайта;</p>
</li>
<li>
<p>Из кампаний удалено поле <code>site_id</code>, теперь кампании связаны с сайтами через источники трафика;</p>
</li>
<li>
<p>Удален метод добавления новой кампании, теперь это происходит автоматически при синхронизации источников трафика;</p>
</li>
<li>
<p>В методы получения информации о кампании добавлено поле <code>source_id</code>;</p>
</li>
<li>
<p>Метод добавления расходов перенесет из раздела <code>Сайты</code> в раздел <code>Источники трафика</code> и добавлен способ добавления расхода на период;</p>
</li>
</ul>
<p><code>1.9</code></p>
<ul>
...
<ul>
<li>
<p>Добавлено поле order для сайтов, позволяющее сортировать список произвольним образов,
а так же метод обновления информации сайта. Поле order используется для сортировки по умолчанию.</p>
</li>
<li>
<p>Добавлена пагинация списка кампаний сайта.</p>
</li>
<li>
<p>Для всех запросов с пагинацией добавлен заголовок RecordsCount с общим количеством найденных записей.</p>
</li>
</ul>
<p><code>1.6</code></p>
<ul>
<li>
<p>В методах получения групп объявлений и ключевых фраз кампании добавлена пагинация.</p>
</li>
<li>
<p>В методах получения ключевых фраз группы объявлений добавлена пагинация.</p>
</li>
<li>
<p>Исправлена сортировка в списке заявок проекта и списке заявок сайта.</p>
</li>
</ul>
<p><code>1.5</code></p>
<ul>
<li>Добавлены методы удаления настроек биддера для кампаний, групп объявлений и ключевых фраз.</li>
</ul>
<p><code>1.4</code></p>
<ul>
...
<h2 class="group-heading">Reference <a href="#" class="permalink">&para;</a></h2><div id="проекты" class="resource"><div id="проекты-get" class="action get"><div class="action-name"><span class="action-resource">Проекты</span><span class="action-dif">/</span><span class="action-title">Список проектов</span></div><h4 class="action-heading"><a href="#проекты-get" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/projects</div></h4><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p>ID проекта</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">number</span><p>Заголовок</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">icon</td><td><span class="attribute-type">string</span><p>Иконка</p><p><b>'string'</b></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">icon</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
    </span>}
  ]
...
</span>}</code></pre></div></div></div></div></div><div id="проекты-post" class="action post"><div class="action-name"><span class="action-resource">Проекты</span><span class="action-dif">/</span><span class="action-title">Создать новый проект</span></div><h4 class="action-heading"><a href="#проекты-post" class="method post">POST</a><div class="code">http://analitics.catkitcms.ru/api/projects</div></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Иконка</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value">{
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        "<span class="hljs-attribute">id</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"ID добавленного проекта"</span>
        </span>}
      </span>}
    </span>}
  </span>}
</span>}</code></pre></div></div></div></div></div><div id="проекты-put" class="action put"><div class="action-name"><span class="action-resource">Проекты</span><span class="action-dif">/</span><span class="action-title">Обновить данные проекта</span></div><h4 class="action-heading"><a href="#проекты-put" class="method put">PUT</a><div class="code">http://analitics.catkitcms.ru/api/projects</div></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Иконка</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
  ...
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span>
</span>}</code></pre></div></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value"><span class="hljs-string">"Hello, world!"</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID проекта</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров рекламных объявлений за период.</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов с сайтов проекта.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">views</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">calls</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">emails</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="проекты-get-6" class="action get"><div class="action-name"><span class="action-resource">Проекты</span><span class="action-dif">/</span><span class="action-title">Список заявок</span></div><h4 class="action-heading"><a href="#проекты-get-6" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/projects/{id}/leads?{from}=&amp;{to}=&amp;{order}=&amp;{reverse}=&amp;{page}</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID проекта</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>order</td><td><span class="attribute-type">string</span><p>Поле для сортировки</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>reverse</td><td><span class="attribute-type">boolean</span><p>Сортировка в обратном порядке</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>page</td><td><span class="attribute-type">string</span><p>Номер страницы списка (начиная от 1) и количество результатов на странице, разделенные запятыми</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    <span class="hljs-string">"'string'"</span>,
    {
      "<span class="hljs-attribute">site_id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"email"</span></span>,
      "<span class="hljs-attribute">source</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">campaign</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">keyword</span>": <span class="hljs-value"><span class="hljs-string">"Hello, world!"</span></span>,
      "<span class="hljs-attribute">place</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">time</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">phone</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">unique</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">duration</span>": <span class="hljs-value"><span class="hljs-number">0</span>
    </span>}
  ]
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID проекта</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    <span class="hljs-string">"'string'"</span>,
    {
      "<span class="hljs-attribute">date</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span>
    </span>}
  ]
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
...
</span>}</code></pre></div></div></div></div></div></div><div id="аккаунты" class="resource"><div id="аккаунты-get" class="action get"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Список доступных типов и настроек</span></div><h4 class="action-heading"><a href="#аккаунты-get" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/accounts/types</div></h4><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width=""></td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">type</td><td><span class="attribute-type">number</span><p>Ключ для типа аккаунта</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">human</td><td><span class="attribute-type">string</span><p>Название типа</p><p><b>'string'</b></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">options</td><td><span class="attribute-type">array</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">undefined</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">human</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="аккаунты-get-2" class="action get"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Подробная информация и настройки</span></div><h4 class="action-heading"><a href="#аккаунты-get-2" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/accounts/{id}</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID аккаунта</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width=""></td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p>ID</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">site_id</td><td><span class="attribute-type">number</span><p>ID свзанного сайта</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">type</td><td><span class="attribute-type">string</span><p>Тип аккаунта</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Название</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">sriteria</td><td><span class="attribute-type">string</span><p>Строка для определения принадлежности заявки источнику трафика</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">human</td><td><span class="attribute-type">string</span><p>Название типа аккаунта</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">options</td><td><span class="attribute-type">array</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute"></span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        ...
        "<span class="hljs-attribute">type</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Тип аккаунта"</span>
        </span>}</span>,
        "<span class="hljs-attribute">caption</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
        ...
        "<span class="hljs-attribute">human</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Название типа аккаунта"</span>
        </span>}</span>,
        "<span class="hljs-attribute">options</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"array"</span></span>,
          "<span class="hljs-attribute">items</span>": <span class="hljs-value">[
...
</span>}</code></pre></div></div></div></div></div><div id="аккаунты-post" class="action post"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Добавить новый аккаунт</span></div><h4 class="action-heading"><a href="#аккаунты-post" class="method post">POST</a><div class="code">http://analitics.catkitcms.ru/api/accounts</div></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">type</td><td><span class="attribute-type">string</span><p>Тип аккаунта</p></td></tr><tr><td class="attribute-status"><span class="required"></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Название аккаунта</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">options</td><td><span class="attribute-type">object</span><p>Массив настроек аккаунта в виде name-value</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">name - value</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">options</span>": <span class="hljs-value">{
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    ...
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Название аккаунта"</span>
    </span>}</span>,
    "<span class="hljs-attribute">options</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Массив настроек аккаунта в виде name-value"</span>
    </span>}
  </span>}</span>,
  "<span class="hljs-attribute">required</span>": <span class="hljs-value">[
    <span class="hljs-string">"type"</span>,
...
</span>}</code></pre></div></div></div></div></div><div id="аккаунты-put" class="action put"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Редактировать аккаунт</span></div><h4 class="action-heading"><a href="#аккаунты-put" class="method put">PUT</a><div class="code">http://analitics.catkitcms.ru/api/accounts</div></h4><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Новое название аккаунта</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">options</td><td><span class="attribute-type">object</span><p>Массив настроек аккаунта в виде name-value</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">name - value</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">options</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">name - value</span>": <span class="hljs-value"><span class="hljs-string">"Hello, world!"</span>
  </span>}
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Новое название аккаунта"</span>
    </span>}</span>,
    "<span class="hljs-attribute">options</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
...
</span>}</code></pre></div></div></div></div></div><div id="аккаунты-delete" class="action delete"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Удалить аккаунт</span></div><h4 class="action-heading"><a href="#аккаунты-delete" class="method delete">DELETE</a><div class="code">http://analitics.catkitcms.ru/api/accounts/{id}</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID аккаунта</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button">Headers</a></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div></div></div></div></div><div id="аккаунты-get-3" class="action get"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Список локальных кампаний аккаунта</span></div><h4 class="action-heading"><a href="#аккаунты-get-3" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/accounts/{id}/campaigns</div></h4><p>Возвращает список добавленных кампаний, принадлежащих аккаунту.</p>
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID аккаунта</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">rel_id</td><td><span class="attribute-type">number</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">rel_id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        ...
        "<span class="hljs-attribute">rel_id</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span>
        </span>}</span>,
        "<span class="hljs-attribute">caption</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span>
...
</span>}</code></pre></div></div></div></div></div><div id="аккаунты-get-4" class="action get"><div class="action-name"><span class="action-resource">Аккаунты</span><span class="action-dif">/</span><span class="action-title">Загрузить список кампаний аккаунта</span></div><h4 class="action-heading"><a href="#аккаунты-get-4" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/accounts/{id}/campaigns/load</div></h4><p>Загружает с соответствующего аккаунту сервера список кампаний.</p>
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID аккаунта</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"Hello, world!"</span>
  </span>}
  ...
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      ...
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">sriteria</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
    </span>}
  ]
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="сайты-get-2" class="action get"><div class="action-name"><span class="action-resource">Сайты</span><span class="action-dif">/</span><span class="action-title">Общая статистика сайта</span></div><h4 class="action-heading"><a href="#сайты-get-2" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/sites/{id}/statistics/summary?{from}=&amp;{to}=</div></h4><p>Возвращает объект с суммой статистик по всем кампаниям, принадлежащим сайту, за указанный период.</p>
...
</span>}</code></pre></div></div></div></div></div><div id="сайты-get-3" class="action get"><div class="action-name"><span class="action-resource">Сайты</span><span class="action-dif">/</span><span class="action-title">Подробная статистика сайта</span></div><h4 class="action-heading"><a href="#сайты-get-3" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/sites/{id}/statistics/details?{from}=&amp;{to}=</div></h4><p>Возвращает массив объектов с суммой почасовых статистик по всем кампаниям проекта за указанный период.</p>
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID сайта</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    <span class="hljs-string">"'string'"</span>,
    {
  ...
  "<span class="hljs-attribute">orders</span>": <span class="hljs-value"><span class="hljs-number">0</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">orders</span>": <span class="hljs-value">{
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID сайта</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>method</td><td><span class="attribute-type">string</span><p>Способ задания меток</p><p><b>only</b> - Установить только заданные метки, остальные удалить</p><p><b>replace</b> - Обновить заданные метки, остальные не изменять. Выбран по умолчанию</p><p><b>all</b> - Обновить заданные метки, остальные очистить</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">utm_source</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_medium</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_campaign</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_content</td><td><span class="attribute-type">string</span><p></p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">utm_term</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">utm_source</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">utm_medium</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">utm_campaign</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">utm_content</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">utm_term</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID сайта</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">domain</td><td><span class="attribute-type">string</span><p>Доменное имя</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">order</td><td><span class="attribute-type">number</span><p>Значение для сортировки по умолчанию</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
  "<span class="hljs-attribute">criteria</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">site_id</span>": <span class="hljs-value">{
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        "<span class="hljs-attribute">id</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"ID добавленного источника"</span>
        </span>}
      </span>}
    </span>}
  </span>}
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        "<span class="hljs-attribute">id</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"ID источника"</span>
        </span>}
      </span>}
    </span>}
  </span>}
</span>}</code></pre></div></div></div></div></div><div id="источники-трафика-delete" class="action delete"><div class="action-name"><span class="action-resource">Источники трафика</span><span class="action-dif">/</span><span class="action-title">Удалить источник</span></div><h4 class="action-heading"><a href="#источники-трафика-delete" class="method delete">DELETE</a><div class="code">http://analitics.catkitcms.ru/api/sources/{id}</div></h4><p>Отмечает источник трафика, а так же все его кампании, удаленными.</p>
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID источника</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button">Headers</a></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div></div></div></div></div><div id="источники-трафика-get-1" class="action get"><div class="action-name"><span class="action-resource">Источники трафика</span><span class="action-dif">/</span><span class="action-title">Список кампаний источника трафика</span></div><h4 class="action-heading"><a href="#источники-трафика-get-1" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/sources/{id}/campaigns</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID аккаунта</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">rel_id</td><td><span class="attribute-type">number</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">rel_id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"Hello, world!"</span>
...
</span>}</code></pre></div></div></div></div></div><div id="источники-трафика-post-1" class="action post"><div class="action-name"><span class="action-resource">Источники трафика</span><span class="action-dif">/</span><span class="action-title">Добавление произвольного расхода</span></div><h4 class="action-heading"><a href="#источники-трафика-post-1" class="method post">POST</a><div class="code">http://analitics.catkitcms.ru/api/sources/{id}/costs</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID источника трафика.</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Сумма расхода.</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">comment</td><td><span class="attribute-type">string</span><p>Комментарий к расходу.</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">date</td><td><span class="attribute-type">object</span><p>Период расхода в виде интервала; если не указано, будет установлено текущее время</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">from</td><td><span class="attribute-type">string</span><p>Дата в формате `Y-m-d`</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">to</td><td><span class="attribute-type">string</span><p>Дата в формате `Y-m-d`</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">comment</span>": <span class="hljs-value"><span class="hljs-string">"Hello, world!"</span></span>,
  "<span class="hljs-attribute">date</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">from</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
    "<span class="hljs-attribute">to</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
  </span>}
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    ...
    "<span class="hljs-attribute">comment</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Комментарий к расходу."</span>
    </span>}</span>,
    "<span class="hljs-attribute">date</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        "<span class="hljs-attribute">from</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Дата в формате `Y-m-d`"</span>
        </span>}</span>,
      ...
      "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Период расхода в виде интервала; если не указано, будет установлено текущее время"</span>
    </span>}
  </span>}</span>,
  "<span class="hljs-attribute">required</span>": <span class="hljs-value">[
    <span class="hljs-string">"cost"</span>
    ...
    <span class="hljs-string">"'string'"</span>,
    {
      "<span class="hljs-attribute">current</span>": <span class="hljs-value">[
        <span class="hljs-string">"'string'"</span>,
        {
          ...
          "<span class="hljs-attribute">position</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
        </span>}
      ]
    </span>}
  ]
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров рекламных объявлений за период.</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков</p></td></tr><tr><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">calls</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
  "<span class="hljs-attribute">emails</span>": <span class="hljs-value"><span class="hljs-number">0</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">options</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">overrides</td><td><span class="attribute-type">object</span><p>список ID дочерних элементов, которые переопределяют настройки кампании</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">ag_groups</td><td><span class="attribute-type">array</span><p>Группы объявлений кампании, для которых указаны другие настройки биддера</p></td></tr><tr><td></td><td></td><td class="attribute-status"><span></span></td><td width="">keywords</td><td><span class="attribute-type">array</span><p>Ключевые фразы кампании, для которых указаны другие настройки биддера</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">hit</td><td><span class="attribute-type">number</span><p>Показатель попадания ставки в процентах, рассчитанный при последнем срабатывании биддера для этой кампании.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">options</span>": <span class="hljs-value">[
      <span class="hljs-string">"'string'"</span>,
      {
        ...
        "<span class="hljs-attribute">increment</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
        ...
        "<span class="hljs-attribute">hit</span>": <span class="hljs-value"><span class="hljs-number">0</span>
      </span>}
    ]</span>,
    "<span class="hljs-attribute">overrides</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">keywords</span>": <span class="hljs-value">[
        ...
        {
          "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
          "<span class="hljs-attribute">ad_group_id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
          "<span class="hljs-attribute">keyword</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
        </span>}
      ]
    </span>}</span>,
    "<span class="hljs-attribute">hit</span>": <span class="hljs-value"><span class="hljs-number">0</span>
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">max</td><td><span class="attribute-type">number</span><p>Максимальная ставка</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">position</td><td><span class="attribute-type"></span><p>Позиция, строка по формуле Pnm, где n - , m -</p><p><b>P11</b></p><p><b>P12</b></p><p><b>P13</b></p><p><b>P14</b></p><p><b>P21</b></p><p><b>P22</b></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">increment</td><td><span class="attribute-type">number</span><p>Процент завышения ставки</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">active</td><td><span class="attribute-type">boolean</span><p>Статус (включено/выключено)</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">day_num</td><td><span class="attribute-type">number</span><p>Порядковый номер дня недели от 0 (понедельник) до 6, для которого должны применяться настройки</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">hour_num</td><td><span class="attribute-type">number</span><p>Порядковый номер часа от 0 до 23, для которого должны применяться настройки</p></td></tr></thead></table></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span>
</span>}</code></pre></div></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button">Headers</a></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div></div></div></div></div><div id="кампании-get-5" class="action get"><div class="action-name"><span class="action-resource">Кампании</span><span class="action-dif">/</span><span class="action-title">Список ключевых фраз</span></div><h4 class="action-heading"><a href="#кампании-get-5" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/campaigns/{id}/keywords?{mask}=&amp;{page}=&amp;</div></h4><p>Возвращает нужное кол-во ключевых фраз, принадлежащих кампании.</p>
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>mask</td><td><span class="attribute-type">string</span><p>Маска для подбора ключевых фраз. Если маска не указана, ключевые фразы не будут фильтроваться.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>page</td><td><span class="attribute-type">string</span><p>Номер страницы списка (начиная от 1) и количество результатов на странице, разделенные запятыми</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p>ID ключевой фразы</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">keyword</td><td><span class="attribute-type">string</span><p>Ключевая фраза</p><p><b>'string'</b></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">keyword</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
...
</span>}</code></pre></div></div></div></div></div><div id="кампании-get-6" class="action get"><div class="action-name"><span class="action-resource">Кампании</span><span class="action-dif">/</span><span class="action-title">Список групп объявлений</span></div><h4 class="action-heading"><a href="#кампании-get-6" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/campaigns/{id}/ad_groups?{page}=&amp;</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID кампании</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>page</td><td><span class="attribute-type">string</span><p>Номер страницы списка (начиная от 1) и количество результатов на странице, разделенные запятыми</p></td></tr></table></div><div class="title"><strong>Request</strong></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p>ID группы</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Заголовок группы</p><p><b>'string'</b></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
...
</span>}</code></pre></div></div></div></div></div><div id="группы-объявлений-get-1" class="action get"><div class="action-name"><span class="action-resource">Группы объявлений</span><span class="action-dif">/</span><span class="action-title">Детали группы</span></div><h4 class="action-heading"><a href="#группы-объявлений-get-1" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/ad_groups/{id}</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID фразы</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width=""></td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p>ID группы</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">caption</td><td><span class="attribute-type">string</span><p>Заголовок группы</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">bids</td><td><span class="attribute-type">array</span><p>Настройки биддера для группы</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">undefined</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">caption</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
    "<span class="hljs-attribute">bids</span>": <span class="hljs-value">[
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID группы объявлений</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>mask</td><td><span class="attribute-type">string</span><p>Маска для подбора ключевых фраз. Если маска не указана, ключевые фразы не будут фильтроваться.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>page</td><td><span class="attribute-type">string</span><p>Номер страницы списка (начиная от 1) и количество результатов на странице, разделенные запятыми</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span class="required"></span></td><td width="">data</td><td><span class="attribute-type">array</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">id</td><td><span class="attribute-type">number</span><p>ID ключевой фразы</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">keyword</td><td><span class="attribute-type">string</span><p>Ключевая фраза</p><p><b>'string'</b></p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      "<span class="hljs-attribute">id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">keyword</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span>
  ...
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">[
    {
      ...
      "<span class="hljs-attribute">keyword</span>": <span class="hljs-value"><span class="hljs-string">"'string'"</span></span>,
      "<span class="hljs-attribute">campaign_id</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
      "<span class="hljs-attribute">ad_group_id</span>": <span class="hljs-value"><span class="hljs-number">0</span>
    </span>}
  ]
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
...
<div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>id</td><td><span class="attribute-type">number</span><p>ID ключевой фразы</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>from</td><td><span class="attribute-type">string</span><p>Дата начала периода в формате `YYYY-mm-dd`.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td>to</td><td><span class="attribute-type">string</span><p>Дата окончания периода (опционально для периода больше 1 дня).</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков с указанным utm_term для данного ключевого слова</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем с указанным utm_term для данного ключевого слова</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  ...
  "<span class="hljs-attribute">period</span>": <span class="hljs-value"><span class="hljs-number">0</span>
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">period</span>": <span class="hljs-value">{
  ...
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span>
</span>}</code></pre></div></div></div></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button">Headers</a></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div id="сервис-общей-статистики" class="resource"><p>Сервис предоставляет предварительно кэшированную статистику для всех ресурсов с возможностью сортировки и пагинации.</p>
<ul>
<li>
<p>Каждый ресурс принимает параметры <code>from</code> и <code>to</code> для определения диапазона, за который необходимо получить статистику. При указании только параметра <code>from</code> будет отображена статистика только за 1 день.</p>
</li>
<li>
<p>Каждый ресурс принимает дополнительные параметры <code>page=page,count</code>, <code>order=field</code>, <code>reverse=1</code> и возвращает заголовок <code>RecordsCount</code> с общим количеством найденных результатов.</p>
</li>
<li>
<p>Все уточняющие параметры взаимно дополняют друг-друга.</p>
</li>
</ul>
<div id="сервис-общей-статистики-get" class="action get"><div class="action-name"><span class="action-resource">Сервис общей статистики</span><span class="action-dif">/</span><span class="action-title">Статистика ключевых фраз</span></div><h4 class="action-heading"><a href="#сервис-общей-статистики-get" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/statistics/keywords?{campaign_id}=&amp;{ad_group_id}=&amp;{keyword_ids}=</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>campaign_id</td><td><span class="attribute-type">number</span><p>ID кампании для подбора ключевых фраз</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>ad_group_id</td><td><span class="attribute-type">number</span><p>ID группы объявлений для подбора ключевых фраз</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>keyword_ids</td><td><span class="attribute-type">array</span><p>список ID ключевых фраз (массив, или разделенные запятой значения)</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков с указанным utm_term для данного ключевого слова</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем с указанным utm_term для данного ключевого слова</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">ctr</td><td><span class="attribute-type">number</span><p>CTR</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_perc</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/клики</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_cost</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_perc</td><td><span class="attribute-type">number</span><p>Заказы/суммарное число заявок</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_cost</td><td><span class="attribute-type">number</span><p>Заказы/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">views</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">calls</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">emails</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">ctr</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">lead_perc</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">lead_cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">order_perc</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">order_cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">orders</span>": <span class="hljs-value"><span class="hljs-number">0</span>
  </span>}
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        ...
        "<span class="hljs-attribute">ctr</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"CTR"</span>
        </span>}</span>,
        "<span class="hljs-attribute">lead_perc</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Суммарное число заявок/клики"</span>
        </span>}</span>,
        "<span class="hljs-attribute">lead_cost</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Суммарное число заявок/расход"</span>
        </span>}</span>,
        "<span class="hljs-attribute">order_perc</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Заказы/суммарное число заявок"</span>
        </span>}</span>,
        "<span class="hljs-attribute">order_cost</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Заказы/расход"</span>
        </span>}</span>,
        "<span class="hljs-attribute">orders</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span></span>,
          "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"Кол-во заказов."</span>
        </span>}
      </span>}
    </span>}
  </span>}
</span>}</code></pre></div></div></div></div></div><div id="сервис-общей-статистики-get-1" class="action get"><div class="action-name"><span class="action-resource">Сервис общей статистики</span><span class="action-dif">/</span><span class="action-title">Статистика групп объявлений</span></div><h4 class="action-heading"><a href="#сервис-общей-статистики-get-1" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/statistics/ad_groups?{campaign_id}=&amp;{ad_group_ids}=</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>campaign_id</td><td><span class="attribute-type">number</span><p>ID кампании для подбора групп объявлений</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>ad_group_ids</td><td><span class="attribute-type">array</span><p>список ID групп объявлений (массив, или разделенные запятой значения)</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков с указанным utm_term, принадлежащим этой группе объявлений</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем с указанным utm_term, принадлежащим этой группе объявлений</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">ctr</td><td><span class="attribute-type">number</span><p>CTR</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_perc</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/клики</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_cost</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_perc</td><td><span class="attribute-type">number</span><p>Заказы/суммарное число заявок</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_cost</td><td><span class="attribute-type">number</span><p>Заказы/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">views</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="сервис-общей-статистики-get-2" class="action get"><div class="action-name"><span class="action-resource">Сервис общей статистики</span><span class="action-dif">/</span><span class="action-title">Статистика кампаний</span></div><h4 class="action-heading"><a href="#сервис-общей-статистики-get-2" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/statistics/campaigns?{site_id}=&amp;{campaign_ids}=</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>site_id</td><td><span class="attribute-type">number</span><p>ID сайта для подбора кампаний</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>campaign_ids</td><td><span class="attribute-type">array</span><p>список ID кампаний (массив, или разделенные запятой значения)</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров рекламных объявлений за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">ctr</td><td><span class="attribute-type">number</span><p>CTR</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_perc</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/клики</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_cost</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_perc</td><td><span class="attribute-type">number</span><p>Заказы/суммарное число заявок</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_cost</td><td><span class="attribute-type">number</span><p>Заказы/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">views</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="сервис-общей-статистики-get-3" class="action get"><div class="action-name"><span class="action-resource">Сервис общей статистики</span><span class="action-dif">/</span><span class="action-title">Статистика сайтов</span></div><h4 class="action-heading"><a href="#сервис-общей-статистики-get-3" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/statistics/campaigns?{project_id}=&amp;{site_ids}=</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>project_id</td><td><span class="attribute-type">number</span><p>ID проекта для подбора сайтов</p></td></tr><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>site_ids</td><td><span class="attribute-type">array</span><p>список ID сайтов (массив, или разделенные запятой значения)</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров рекламных объявлений за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов.</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">views</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
...
</span>}</code></pre></div></div></div></div></div><div id="сервис-общей-статистики-get-4" class="action get"><div class="action-name"><span class="action-resource">Сервис общей статистики</span><span class="action-dif">/</span><span class="action-title">Статистика проектов</span></div><h4 class="action-heading"><a href="#сервис-общей-статистики-get-4" class="method get">GET</a><div class="code">http://analitics.catkitcms.ru/api/statistics/projects?{project_id}=</div></h4><div class="title"><strong>Parameters</strong></div><div class="div"><table class="inner"><tr><td></td><td class="attribute-status"><span class="required"></span></td><td>project_id</td><td><span class="attribute-type">number</span><p>ID проекта для получения статистики</p></td></tr></table></div><div class="title"><strong>Response&nbsp;&nbsp;<code>200</code></strong></div><div><div class="inner"><div class="tabs r-tabs"><div class="tabs-menu"><a data-tab="attributes" class="tab-button active">Attributes</a><a data-tab="attributes" class="tab-button">Headers</a><a data-tab="attributes" class="tab-button">Body</a><a data-tab="attributes" class="tab-button">Schema</a></div><div data-tab="attributes" class="tab active"><table style="width: 100%;"><thead><tr><td class="attribute-status"><span></span></td><td width="">data</td><td><span class="attribute-type">object</span><p></p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">cost</td><td><span class="attribute-type">number</span><p>Потраченная сумма(руб.).</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">views</td><td><span class="attribute-type">number</span><p>Кол-во просмотров рекламных объявлений за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">clicks</td><td><span class="attribute-type">number</span><p>Кол-во кликов по рекламе за период.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">calls</td><td><span class="attribute-type">number</span><p>Кол-во звонков</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">emails</td><td><span class="attribute-type">number</span><p>Кол-во писем</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">orders</td><td><span class="attribute-type">number</span><p>Кол-во заказов.</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">ctr</td><td><span class="attribute-type">number</span><p>CTR</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_perc</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/клики</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">lead_cost</td><td><span class="attribute-type">number</span><p>Суммарное число заявок/расход</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_perc</td><td><span class="attribute-type">number</span><p>Заказы/суммарное число заявок</p></td></tr><tr><td></td><td class="attribute-status"><span></span></td><td width="">order_cost</td><td><span class="attribute-type">number</span><p>Заказы/расход</p></td></tr></thead></table></div><div data-tab="headers" class="tab"><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div></div><div data-tab="body" class="tab"><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">views</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">clicks</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">calls</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">emails</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">orders</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">ctr</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">lead_perc</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">lead_cost</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">order_perc</span>": <span class="hljs-value"><span class="hljs-number">0</span></span>,
    "<span class="hljs-attribute">order_cost</span>": <span class="hljs-value"><span class="hljs-number">0</span>
  </span>}
</span>}</code></pre><div style="height: 1px;"></div></div><div data-tab="schema" class="tab"><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
...
</span>}</code></pre></div></div></div></div></div></div></div></div></div><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 10 Jun 2018</p><script>/*
