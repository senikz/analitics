...
/**
 * CampaignStatisticsHourlyFixture
 *
 */
class CampaignStatisticsHourlyFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'campaign_statistics_hourly';
